...
const DEMO_ACCOUNTS: DemoAccount[] = [
  {
    ...
    detail: "Active Patient (Upcoming Consultation & Triage)",
    portalUrl: "/patient",
  },
  {
    name: "Praveen",
    ...
    detail: "Hypertension Patient (Lisinopril Reminders)",
    portalUrl: "/patient",
  },
  {
    name: "Dr. Satwik, MD",
    ...
    detail: "Cardiologist (Clinical Queue & Consult Room)",
    portalUrl: "/doctor",
  },
  {
    name: "Dr. Vinith, MD",
    ...
    detail: "Dermatologist (Patient Triage & Bookings)",
    portalUrl: "/doctor",
  },
  {
    name: "Patnaik",
    ...
    detail: "System Administrator (Clinic KPIs & Leaves)",
    portalUrl: "/admin",
  },
];
